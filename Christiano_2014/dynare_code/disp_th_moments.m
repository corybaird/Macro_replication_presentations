function [vardecomp,nnms,vvars] = disp_th_moments(dr,var_list)
...
if ~options_.noprint %options_.nomoments == 0
    ...
    if M_.exo_nbr > 1 && size(stationary_vars, 1) > 0
        ...
        vardecomp=100*oo_.gamma_y{options_.ar+2}(stationary_vars,:);
        nnms=M_.endo_names(ivar(stationary_vars),:);
