...
% Shock equations
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  log(epsil / epsil_p)       = rhoepsil_p    * log(epsil(-1) / epsil_p)       + e_epsil
  ;
  ...
  log(muzstar / muzstar_p)   = rhomuzstar_p  * log(muzstar(-1) / muzstar_p)   + (1 - @{stopshock}) * (1 - @{stopshock}) * e_muzstar
  ;
  ...
  % note that I just let e_g be the stand in for the shock to sigma.  Now
  % everything that was a g shock is a sigma shock and everything that was
  % a sigma shock is a g shock.
  log(sigma / sigma_ss)      = rhosigma_p * log(sigma(-1) / sigma_ss)         + (1 - @{stopshock}) * e_zetai;
  @# if cee == 0
