...
% Shock equations
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  log(epsil / epsil_p)       = rhoepsil_p    * log(epsil(-1) / epsil_p)       + (1 - @{stopshock}) * log(xi03) 
  @#for index in ["1", "2", "3", "4", "5", "6", "7", "8"]
    + log(xi@{index}3(-@{index}))
  @#endfor 
  ;
  ...
  log(muzstar / muzstar_p)   = rhomuzstar_p  * log(muzstar(-1) / muzstar_p)   + (1 - @{stopshock}) * log(xi02) 
  @#for index in ["1", "2", "3", "4", "5", "6", "7", "8"]
    + log(xi@{index}2(-@{index}))
  @#endfor 
  ;
  ...
  log(zetai / zetai_p)       = rhozetai_p    * log(zetai(-1) / zetai_p)       + (1 - @{stopshock}) * log(xi0) 
  @#for index in ["1", "2", "3", "4", "5", "6", "7", "8"]
    + log(xi@{index}(-@{index}))
  @#endfor 
  ;
  ...
  @# if cee == 0
  log(sigma / sigma_ss) = rhosigma_p * log(sigma(-1) / sigma_ss)  + e_s
  ;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Signal equations
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  @#if ("8" in possible_signals)
  log(xi82) = stdsigma22_p * e_xi82;
  @#else
  log(xi82) = 0;
  @#endif
  
  @#if ("7" in possible_signals)
  log(xi72) = signal_corr2_p * stdsigma22_p * e_xi82
  @#for index in ["7"]
    + sqrt(1 - signal_corr2_p^2) * stdsigma22_p * e_xi@{index}2
  @#endfor
  ;
  @#else
  log(xi72) = 0;
  ...
  @#if ("6" in possible_signals)
  log(xi62) = signal_corr2_p^2 * stdsigma22_p * e_xi82
  @#for index in ["7", "6"]
    + sqrt(1 - signal_corr2_p^2) * signal_corr2_p^(@{index} - 6) * stdsigma22_p * e_xi@{index}2
  @#endfor
  ;
  @#else
  log(xi62) = 0;
  ...
  @#if ("5" in possible_signals)
  log(xi52) = signal_corr2_p^3 * stdsigma22_p * e_xi82
  @#for index in ["7", "6", "5"]
    + sqrt(1 - signal_corr2_p^2) * signal_corr2_p^(@{index} - 5) * stdsigma22_p * e_xi@{index}2
  @#endfor
  ;
  @#else
  log(xi52) = 0;
  ...
  @#if ("4" in possible_signals)
  log(xi42) = signal_corr2_p^4 * stdsigma22_p * e_xi82
  @#for index in ["7", "6", "5", "4"]
    + sqrt(1 - signal_corr2_p^2) * signal_corr2_p^(@{index} - 4) * stdsigma22_p * e_xi@{index}2
  @#endfor
  ;
  @#else
  log(xi42) = 0;
  ...
  @#if ("3" in possible_signals)  
  log(xi32) = signal_corr2_p^5 * stdsigma22_p * e_xi82
  @#for index in ["7", "6", "5", "4", "3"]
    + sqrt(1 - signal_corr2_p^2) * signal_corr2_p^(@{index} - 3) * stdsigma22_p * e_xi@{index}2
  @#endfor
  ;
  @#else
  log(xi32) = 0;
  ...
  @#if ("2" in possible_signals)  
  log(xi22) = signal_corr2_p^6 * stdsigma22_p * e_xi82
  @#for index in ["7", "6", "5", "4", "3", "2"]
    + sqrt(1 - signal_corr2_p^2) * signal_corr2_p^(@{index} - 2) * stdsigma22_p * e_xi@{index}2
  @#endfor
  ;
  @#else
  log(xi22) = 0;
  ...
  @#if ("1" in possible_signals)
  log(xi12) = signal_corr2_p^7 * stdsigma22_p * e_xi82
  @#for index in ["7", "6", "5", "4", "3", "2", "1"]
    + sqrt(1 - signal_corr2_p^2) * signal_corr2_p^(@{index} - 1) * stdsigma22_p * e_xi@{index}2
  @#endfor
  ;
  @#else
  log(xi12) = 0;
  ...
  @# if ("0" in possible_signals)
  log(xi02) = signal_corr2_p^8 * stdsigma12_p * e_xi82
  @#for index in ["7", "6", "5", "4", "3", "2", "1"]
    + sqrt(1 - signal_corr2_p^2) * signal_corr2_p^(@{index} - 0) * stdsigma12_p * e_xi@{index}2
  @#endfor
  + sqrt(1-signal_corr2_p^2) * stdsigma12_p * e_sigma2;
  @#else
  log(xi02)=0;
  @#endif  
  ...
  @#if ("8" in possible_signals)
  log(xi83) = stdsigma23_p * e_xi83;
  @#else
  log(xi83) = 0;
  @#endif
  
  @#if ("7" in possible_signals)
  log(xi73) = signal_corr3_p * stdsigma23_p * e_xi83
  @#for index in ["7"]
    + sqrt(1 - signal_corr3_p^2) * stdsigma23_p * e_xi@{index}3
  @#endfor
  ;
  @#else
  log(xi73) = 0;
  ...
  @#if ("6" in possible_signals)
  log(xi63) = signal_corr3_p^2 * stdsigma23_p * e_xi83
  @#for index in ["7", "6"]
    + sqrt(1 - signal_corr3_p^2) * signal_corr3_p^(@{index} - 6) * stdsigma23_p * e_xi@{index}3
  @#endfor
  ;
  @#else
  log(xi63) = 0;
  ...
  @#if ("5" in possible_signals)
  log(xi53) = signal_corr3_p^3 * stdsigma23_p * e_xi83
  @#for index in ["7", "6", "5"]
    + sqrt(1 - signal_corr3_p^2) * signal_corr3_p^(@{index} - 5) * stdsigma23_p * e_xi@{index}3
  @#endfor
  ;
  @#else
  log(xi53) = 0;
  ...
  @#if ("4" in possible_signals)
  log(xi43) = signal_corr3_p^4 * stdsigma23_p * e_xi83
  @#for index in ["7", "6", "5", "4"]
    + sqrt(1 - signal_corr3_p^2) * signal_corr3_p^(@{index} - 4) * stdsigma23_p * e_xi@{index}3
  @#endfor
  ;
  @#else
  log(xi43) = 0;
  ...
  @#if ("3" in possible_signals)  
  log(xi33) = signal_corr3_p^5 * stdsigma23_p * e_xi83
  @#for index in ["7", "6", "5", "4", "3"]
    + sqrt(1 - signal_corr3_p^2) * signal_corr3_p^(@{index} - 3) * stdsigma23_p * e_xi@{index}3
  @#endfor
  ;
  @#else
  log(xi33) = 0;
  ...
  @#if ("2" in possible_signals)  
  log(xi23) = signal_corr3_p^6 * stdsigma23_p * e_xi83
  @#for index in ["7", "6", "5", "4", "3", "2"]
    + sqrt(1 - signal_corr3_p^2) * signal_corr3_p^(@{index} - 2) * stdsigma23_p * e_xi@{index}3
  @#endfor
  ;
  @#else
  log(xi23) = 0;
  ...
  @#if ("1" in possible_signals)
  log(xi13) = signal_corr3_p^7 * stdsigma23_p * e_xi83
  @#for index in ["7", "6", "5", "4", "3", "2", "1"]
    + sqrt(1 - signal_corr3_p^2) * signal_corr3_p^(@{index} - 1) * stdsigma23_p * e_xi@{index}3
  @#endfor
  ;
  @#else
  log(xi13) = 0;
  ...
  @# if ("0" in possible_signals)
  log(xi03) = signal_corr3_p^8 * stdsigma13_p * e_xi83
  @#for index in ["7", "6", "5", "4", "3", "2", "1"]
    + sqrt(1 - signal_corr3_p^2) * signal_corr3_p^(@{index} - 0) * stdsigma13_p * e_xi@{index}3
  @#endfor
  + sqrt(1-signal_corr3_p^2) * stdsigma13_p * e_sigma3;
  @#else
  log(xi03)=0;
  @#endif  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
