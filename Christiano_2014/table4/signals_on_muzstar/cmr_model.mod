...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  log(muzstar / muzstar_p)   = rhomuzstar_p  * log(muzstar(-1) / muzstar_p)   + (1 - @{stopshock}) * (1 - @{stopshock}) * log(xi0) 
  ...
  log(sigma / sigma_ss)      = rhosigma_p * log(sigma(-1) / sigma_ss)         + (1 - @{stopshock}) * e_muzstar;
  @# if cee == 0
